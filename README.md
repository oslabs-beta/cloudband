...
1. For new users, click "Create New Stack.
1. For new users, click "Create New Stack.

1. Follow the link and sign in as an IAM user. Follow the instructions on the How To page or watch our How To Create a New Stack Video Tutorial.
1. Follow the link and sign in as an IAM user. Follow the instructions on the How To page or watch our How To Create a New Stack Video Tutorial.

1. Copy and paste the unique ARN outputted from the prior step.
1. Copy and paste the unique ARN outputted from the prior step.

1. Input the ARN into the Enter ARN Here field
1. Input the ARN into the Enter ARN Here field
...
3. By clicking on the instance id, you can easily toggle an instance's data on or off to view only what you want to see.
...
4. The Cloudband interface allows you to seamlessly switch between your EC2 and Lambda metrics for a more convenient way to view your data.
