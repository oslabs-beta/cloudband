...
// change the path to the mock??
const cloudwatchController = require('../../server/controllers/aws/cloudwatchController');
// do we want this to be a mocked function inside the mock controller?
...
xdescribe('cloudwatchController', () => {
  ...
  const res = {
    locals: {
      ...
      ec2Instances: { instances: ['i-123456789', 'i-2345789'] },
    },
  };
  ...
  xdescribe('getMetrics', () => {
    ...
    it('should get metrics', async () => {
      ...
      const responses = {
        MetricDataResults: [
          { Values: [1, 2, 3], Timestamps: ['Timestamp1', 'Timestamp2'] },
        ],
      };
